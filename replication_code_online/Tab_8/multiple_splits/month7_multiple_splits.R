...
month_1_data <- merged_data %>% filter(month == 7)
...
for (i in 1:n_splits) {
  ...
  save(result_s_learner, file = file.path(split_output_dir, paste0("cates_s_july_learner_split", i, ".RData")))
  ...
  save(result_t_learner, file = file.path(split_output_dir, paste0("cates_t_july_learner_split", i, ".RData")))
  ...
  save(result_r_learner, file = file.path(split_output_dir, paste0("cates_r_july_learner_split", i, ".RData")))
  ...
  save(result_dr_learner, file = file.path(split_output_dir, paste0("cates_dr_july_learner_split", i, ".RData")))
  ...
  save(result_cf_learner, file = file.path(split_output_dir, paste0("cates_cf_july_learner_split", i, ".RData")))
  ...
  save(blp_results_all, file = file.path(split_output_dir, paste0("blp_all_july_learners_split", i, ".RData")))
  # GATES Estimates
  K <- 4
  ...
  save(gates_combined_df, file = file.path(split_output_dir, paste0("gates_df_split_july_", i, ".RData")))
